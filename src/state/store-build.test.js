...
describe('reducer — build', () => {
  ...
  it('selectClass resets the build incl. gearStages', () => {
    const s = reducer({ ...withBase, build: { baseClass: 'acolyte', advancedClass: 'priest', levels: { heal: 5 }, gearStages: [{ toLevel: 1, changes: {} }], notes: 'old', attributes: { str: 3, agi: 1, vit: 1, int: 1, dex: 1, luk: 1 } } }, { type: 'selectClass', slug: 'mage' });
  ...
  it('setGearSlot sets a change; clearGearSlot reverts to carried', () => {
    let s = reducer(withBase, { type: 'addGearStage', toLevel: 1 });
  ...
  it('resetBuild clears levels and gearStages, keeps class', () => {
    const s = reducer({ ...withBase, build: { baseClass: 'acolyte', advancedClass: 'priest', levels: { heal: 5 }, gearStages: [{ toLevel: 1, changes: {} }], notes: 'old', attributes: { str: 3, agi: 1, vit: 1, int: 1, dex: 1, luk: 1 } } }, { type: 'resetBuild' });
