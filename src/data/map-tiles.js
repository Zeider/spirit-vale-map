...
// transformed into our trimmed crop. `zoneId` links to v0.13.1 drop data in
// zones.json; null = newer zone, drops pending the next data snapshot.
export const mapTiles = [
  ...
  { id: 'sunny-meadows-2-6', name: "Sunny Meadows 2", minLevel: 6, maxLevel: 10, isHub: false, x: 41.85, y: 40.19, w: 6.96, h: 9.69, zoneId: null },
  { id: 'forest-field-1-11', name: "Forest Field 1", minLevel: 11, maxLevel: 15, isHub: false, x: 56.11, y: 40.31, w: 6.96, h: 9.69, zoneId: null },
  { id: 'forest-field-2-16', name: "Forest Field 2", minLevel: 16, maxLevel: 20, isHub: false, x: 56.11, y: 50.35, w: 6.96, h: 9.69, zoneId: null },
  { id: 'nevaris-sewers-16', name: "Nevaris Sewers", minLevel: 16, maxLevel: 20, isHub: false, x: 34.71, y: 60.28, w: 6.96, h: 9.69, zoneId: null },
  { id: 'forest-field-2', name: "Treant Trail", minLevel: 5, maxLevel: 9, isHub: false, x: 48.99, y: 30.26, w: 6.96, h: 9.69, zoneId: 'forest-field-2' },
  { id: 'bunny-woods-21', name: "Bunny Woods", minLevel: 21, maxLevel: 25, isHub: false, x: 41.85, y: 50.23, w: 6.96, h: 9.69, zoneId: null },
  { id: 'cemetery', name: "Festering Woods 1", minLevel: 21, maxLevel: 25, isHub: false, x: 48.99, y: 60.28, w: 6.96, h: 9.69, zoneId: 'cemetery' },
  { id: 'festering-woods-2-26', name: "Festering Woods 2", minLevel: 26, maxLevel: 30, isHub: false, x: 56.11, y: 60.4, w: 6.96, h: 9.69, zoneId: null },
  { id: 'lake-field-26', name: "Lake Field", minLevel: 26, maxLevel: 30, isHub: false, x: 34.71, y: 40.31, w: 6.96, h: 9.69, zoneId: null },
  ...
  { id: 'desert-field-1', name: "Windy Desert North", minLevel: 21, maxLevel: 25, isHub: false, x: 63.24, y: 30.26, w: 6.96, h: 9.69, zoneId: 'desert-field-1' },
  { id: 'desert-field-3', name: "Windy Desert South", minLevel: 26, maxLevel: 30, isHub: false, x: 63.33, y: 50.23, w: 6.96, h: 9.69, zoneId: 'desert-field-3' },
  { id: 'mystic-lake-2-36', name: "Mystic Lake 2", minLevel: 36, maxLevel: 40, isHub: false, x: 34.64, y: 20.33, w: 6.96, h: 9.69, zoneId: null },
  ...
  { id: 'goblin-field-41', name: "Goblin Field", minLevel: 41, maxLevel: 45, isHub: false, x: 63.24, y: 20.21, w: 6.96, h: 9.69, zoneId: null },
  ...
  { id: 'goblin-village', name: "Goblin Village", minLevel: 56, maxLevel: 60, isHub: false, x: 77.76, y: 20.21, w: 6.96, h: 9.69, zoneId: 'goblin-village' },
  { id: 'goblin-cave', name: "Goblin Cave 1", minLevel: 51, maxLevel: 55, isHub: false, x: 70.54, y: 30.14, w: 6.96, h: 9.69, zoneId: 'goblin-cave' },
  { id: 'goblin-cave-2-56', name: "Goblin Cave 2", minLevel: 56, maxLevel: 60, isHub: false, x: 77.76, y: 30.26, w: 6.96, h: 9.69, zoneId: null },
  { id: 'island', name: "Stormreef Isle", minLevel: 61, maxLevel: 65, isHub: false, x: 14.18, y: 40.31, w: 6.96, h: 9.69, zoneId: 'island' },
  { id: 'ice-cave', name: "Crystal Cave", minLevel: 66, maxLevel: 70, isHub: false, x: 70.54, y: 10.28, w: 6.96, h: 9.69, zoneId: 'ice-cave' },
  { id: 'swamp-wilderness', name: "Swamp Wilderness", minLevel: 71, maxLevel: 75, isHub: false, x: 63.24, y: 70.33, w: 6.96, h: 9.69, zoneId: 'swamp-wilderness' },
  ...
  { id: 'water-dungeon', name: "Sunken Depths", minLevel: 121, maxLevel: 125, isHub: false, x: 14.18, y: 50.35, w: 6.96, h: 9.69, zoneId: 'water-dungeon' },
  { id: 'abyss-castle-dungeon-106', name: "Abyss Castle Dungeon", minLevel: 106, maxLevel: 110, isHub: false, x: 41.76, y: 80.26, w: 6.96, h: 9.69, zoneId: null },
  { id: 'castle-keep', name: "Abyss Castle Keep", minLevel: 101, maxLevel: 105, isHub: false, x: 34.55, y: 80.26, w: 6.96, h: 9.69, zoneId: 'castle-keep' },
  { id: 'castle-crypt', name: "Abyss Castle Crypt", minLevel: 106, maxLevel: 110, isHub: false, x: 41.85, y: 90.19, w: 6.96, h: 9.69, zoneId: 'castle-crypt' },
  { id: 'castle-library', name: "Abyss Castle Library", minLevel: 111, maxLevel: 115, isHub: false, x: 27.33, y: 80.26, w: 6.96, h: 9.69, zoneId: 'castle-library' },
  { id: 'goblin-warcamp', name: "Goblin Warcamp", minLevel: 116, maxLevel: 120, isHub: false, x: 84.97, y: 20.21, w: 6.96, h: 9.69, zoneId: 'goblin-warcamp' },
  ...
  { id: 'nevaris', name: "Nevaris", minLevel: 0, maxLevel: 0, isHub: true, x: 48.99, y: 50.23, w: 6.96, h: 9.69, zoneId: 'nevaris' },
  { id: 'the-echoing-spire-0', name: "The Echoing Spire", minLevel: 0, maxLevel: 0, isHub: true, x: 20.21, y: 80.26, w: 6.96, h: 9.69, zoneId: null },
  { id: 'port-town', name: "Wayfarer's Landing", minLevel: 0, maxLevel: 0, isHub: true, x: 27.59, y: 40.19, w: 6.96, h: 9.69, zoneId: 'port-town' },
];
